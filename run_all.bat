...
start "Scheduler" cmd /k "cd /d %~dp0 && py -3.11 -c ""from alerts.analysis_scheduler import run_scheduler; from alerts.telegram_commander import start_telegram_commander; start_telegram_commander(); run_scheduler()"""
