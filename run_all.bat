...
start "Scheduler" cmd /k "cd /d %~dp0 && C:\Users\640jj\AppData\Local\Programs\Python\Python311\python.exe -c "from alerts.analysis_scheduler import run_scheduler; from alerts.telegram_commander import start_telegram_commander; start_telegram_commander(); run_scheduler()""
